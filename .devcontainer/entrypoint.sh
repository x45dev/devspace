...
#   2. Run permission validation tests.
#   3. Hand off execution to the container's final command (e.g., sleep infinity)
...
main() {
  ...
  /usr/local/bin/test-permissions.sh

  # Execute the main container command as the non-root user
