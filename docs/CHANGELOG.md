...
- **Documentation Structure:** Renamed and reorganized workflow files (e.g., `project-initiation.md` → `01-project-initiation.md`) and moved analysis files to a subdirectory.
